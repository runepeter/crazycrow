...
public class CrazyCrowResultSet implements ResultSet {

    private final ResultSet delegate;
    private final CrazyCrowStatement statement;

    public CrazyCrowResultSet(final ResultSet delegate, final CrazyCrowStatement statement) {
    ...
    public boolean equals(final Object o) {
        ...
        final CrazyCrowResultSet that = (CrazyCrowResultSet) o;
